  ...
  Widget build(BuildContext context) {
    ...
    return OutlinedButton(
      onPressed: () async {
        ...
        if (categoryTitle.isNotEmpty || categoryTitle != categoryModel.categoryTitle || categoryColorIndex != categoryModel.categoryColorIndex || categoryPeriodIndex != categoryModel.categoryPeriodIndex) {
