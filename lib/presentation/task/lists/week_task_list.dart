...
class WeekTaskList extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final DateTime startTime = restTimeState.getRestTimeIndicator(TaskPeriod.week)[AppConstraints.startDateTime];
    final DateTime endTime = restTimeState.getRestTimeIndicator(TaskPeriod.week)[AppConstraints.endDateTime];
