...
class SeasonTaskList extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final DateTime startTime = restTimeState.getRestTimeIndicator(TaskPeriod.season)[AppConstraints.startDateTime];
    final DateTime endTime = restTimeState.getRestTimeIndicator(TaskPeriod.season)[AppConstraints.endDateTime];
