...
class DayTaskList extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final DateTime startTime = restTimeState.getRestTimeIndicator(TaskPeriod.day)[AppConstraints.startDateTime];
    final DateTime endTime = restTimeState.getRestTimeIndicator(TaskPeriod.day)[AppConstraints.endDateTime];
